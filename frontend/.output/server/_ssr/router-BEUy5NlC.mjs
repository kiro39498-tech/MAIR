...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal$1, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
...
function AppSidebar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center gap-3 px-4 py-4",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-[10px] bg-primary text-white shadow-sm",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Factory, { className: "h-5 w-5" })
			...
			className: "text-xs font-bold uppercase tracking-wider text-muted-foreground mt-2 mb-1 px-4",
			children: "Workspace"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, {
			className: "px-2",
...
var Route$4 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{ title: "Material Availability & Inventory Replenishment Agent" },
			{
				name: "description",
				content: "Operational dashboard for material availability, inventory health, and replenishment recommendations."
			},
			{
				property: "og:title",
				content: "Material Availability & Inventory Replenishment Agent"
			},
			{
...
function RootComponent() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChatProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex min-h-screen w-full bg-background",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-1 flex-col min-w-0",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					className: "sticky top-0 z-10 flex h-16 items-center justify-between border-b bg-card px-6",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarTrigger, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								...
								children: "Material Availability & Inventory Replenishment Agent"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-xs text-muted-foreground",
								children: "Planning · Inventory health · Replenishment"
							})]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-bold text-muted-foreground shadow-sm bg-card tracking-wider",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-2.5 w-2.5 rounded-full bg-emerald-500" }), "LIVE SYNC"]
					})]
...
var MaterialsRoute = Route$3.update({
	id: "/materials",
	path: "/materials",
	getParentRoute: () => Route$4
});
var CopilotRoute = Route$2.update({
	id: "/copilot",
	path: "/copilot",
	getParentRoute: () => Route$4
});
...
var MaterialsRouteChildren = { MaterialsMaterialIdPlantIdRoute: Route.update({
...
var rootRouteChildren = {
	IndexRoute,
	CopilotRoute,
	MaterialsRoute: MaterialsRoute._addFileChildren(MaterialsRouteChildren),
